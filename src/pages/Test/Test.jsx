...
export default function NewMovie() {
  ...
  const handleSubmit = async (e) => {
    e.preventDefault();
    const res =await axios.put(`http://localhost:3001/movie/${movieId}`, movie);
    console.log(res);
  ...
  return (
    ...
    <div className="newProduct">
      ...
      {movie && <form className="addProductForm">
        ...
        <div className="addProductItem">
          ...
          <select name="isSeries" id="isSeries" onChange={handleChange} value={movie.isSeries}>
